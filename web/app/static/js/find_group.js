...
function testt(h){
  ...
  console.log('Test_find ==>', find_code(data, h, ''))
  console.log('id_find_position_course ==> {{{', id_find_position_course, '}}}')
  console.log('id_find_position_course_grade => ', id_find_position_course_grade)
  ...
  // }
  return id_find_position_course;
}
